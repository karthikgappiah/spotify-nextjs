...
function TableHead({ className, ...props }: ColumnProps) {
  return (
    <ColumnPrimitive
      ...
      className={cn(
        "h-10 whitespace-nowrap px-2 text-left align-middle font-medium text-foreground has-[[role=checkbox]]:pr-0 has-data-[slot=checkbox]:pr-0",
        className,
      )}
      {...props}
    />
...
function TableCell({ className, ...props }: CellProps) {
  return (
    <CellPrimitive
      ...
      className={cn(
        "whitespace-nowrap p-2 align-middle has-[[role=checkbox]]:pr-0 has-data-[slot=checkbox]:pr-0",
        className,
      )}
      {...props}
    />
