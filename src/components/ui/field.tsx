...
function FieldError({
  ...
  const content = useMemo(() => {
    ...
    // biome-ignore lint/suspicious/noDoubleEquals: code generated by shadcn/ui
    ...
    return (
      <ul className="ml-4 flex list-disc flex-col gap-1">
        {uniqueErrors.map(
          (error, index) =>
            // biome-ignore lint/suspicious/noArrayIndexKey: code generated by shadcn/ui
